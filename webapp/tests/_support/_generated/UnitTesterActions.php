<?php  //[STAMP] 2417ee5ed83f7a53c93f1e72faf24a4c
...
trait UnitTesterActions
{
     ...
     *
     *
     * @see \Helper\DbHelper::runMigrations()
     */
    public function runMigrations() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('runMigrations', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\DbHelper::runFixtures()
     */
    public function runFixtures($names) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('runFixtures', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\DbHelper::runSQLFiles()
     */
    public function runSQLFiles($filepaths) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('runSQLFiles', func_get_args()));
    }
}
